...
$out = @()
$out += "--- Hindi Original ---"
$out += ($hLines | Select-String -Pattern "314\." -Context 1, 2)
$out += "--- Hindi Saral ---"
$out += ($hsLines | Select-String -Pattern "314" -Context 1, 2)

[System.IO.File]::WriteAllLines("c:\Users\DeLL\Desktop\hiCONSTITUTION\scratch\out314.txt", $out, [System.Text.Encoding]::UTF8)
